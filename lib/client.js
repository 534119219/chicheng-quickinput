	...
	factory: (require) => {
		...
		function VaultPanel(props) {
			...
			var privateHint = !unlocked && hasPrivate
				? createElement("div", { style: { margin: "8px 12px 0", border: "1px solid var(--dsw-alias-border-l1, var(--dsw-alias-border-l2))", borderRadius: 10, background: "var(--dsw-alias-bg-layer-2)", padding: "7px 11px", fontSize: 11.5, color: "var(--dsw-alias-label-tertiary)", lineHeight: 1.5, flex: "none" } },
					t("privateLockedHint"))
				: null;
